...
{
    int i;
    int screenWidth = 176;  // screen width of the TFT display
    int screenHeight = 220; // sreen height of the tft display
    int offsetx = 0;
    int offsety = 0;
    char dir[128];
    char cpath[128];
    ...
    if (JAPANESE)
        strncpy((char *)utf8, "16ドットゴシック", sizeof(utf8));
    ...
    if (JAPANESE)
        strncpy((char *)utf8, "24ドットゴシック", sizeof(utf8));
    ...
    if (screenWidth >= 240)
    {
        ...
        if (JAPANESE)
            strncpy((char *)utf8, "32ドットゴシック", sizeof(utf8));
    ...
    if (JAPANESE)
        strncpy((char *)utf8, "16ドット明朝", sizeof(utf8));
    ...
    if (JAPANESE)
        strncpy((char *)utf8, "24ドット明朝", sizeof(utf8));
    ...
    if (screenWidth >= 240)
    {
        ...
        if (JAPANESE)
            strncpy((char *)utf8, "32ドット明朝", sizeof(utf8));
